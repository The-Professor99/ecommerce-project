    ...
    <footer className="divide-y px-4 dark:dark:bg-gray-800 dark:dark:text-gray-100">
      <div className="container mx-auto flex flex-col justify-between space-y-8 py-10 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full dark:dark:bg-violet-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                fill="currentColor"
                className="h-5 w-5 flex-shrink-0 rounded-full dark:dark:text-gray-900"
              >
